...
def parse_variant(v: dict | None) -> dict:
    ...
    best = max(((a / n, pid) for pid, (a, n) in pops.items() if n), default=(None, None))
    return {"af_global": af, "af_popmax": best[0], "popmax_pop": best[1], "allele_count": ac, "not_found": False}
