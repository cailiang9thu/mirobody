...
#:
#: The narrative row admits only the two scales the 2.83 cut excludes, so a
#: narrative value abstains. Admitting `Nom` coded `Abdomen` / "No
#: abnormalities seen" to 111845-4, "Previous history of abdominal surgeries".
_SCALES: dict[str, frozenset[str]] = {
    ...
    KIND_NARRATIVE: frozenset({"Nar", "Doc"}),
}
