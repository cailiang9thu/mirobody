...
async def init():
    ...
    try:
        from mirobody.collect.aggregate.startup import start_aggregate_indicator_scheduler
    ...
    try:
        from mirobody.collect.standardize.std_indicator_registry.startup import start_std_indicator_registry
