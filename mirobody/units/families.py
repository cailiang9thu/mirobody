...
UCUM_FAMILY: dict[str, str] = {
    ...
    "mm":       "Len",
    "um":       "Len",
    # LOINC prints particle sizes in nanometres and, on one lipoprotein code,
    # in angstrom. Neither mapped to anything, so those readings could not
    # pick a variant by unit at all.
    "nm":       "Len",
    "Ao":       "Len",
    "km":       "Len",
